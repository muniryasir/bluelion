...
const appShell = [
    '/static/commune_de_paris/static/manifest.webmanifest',
    '/',
...
console.log(JSON.stringify(cache_files));
workbox.precaching.precacheAndRoute(cache_files, {   urlManipulation: ({url}) => {   return html_files  } });

workbox.routing.registerRoute(({url}) => site_links.includes(url), new workbox.strategies.CacheOnly());
