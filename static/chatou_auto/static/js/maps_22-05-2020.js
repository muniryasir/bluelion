      ...
      for (var i=0; i<stepMarkers.length; i++) {
        ...
        if (stepMarkers[i].getPosition().equals(markerstep.getPosition())) { 
          ...
          google.maps.event.addListener(stepinfowindows[i], 'domready', function() {
            ...
            var img;
            if (pin_color == "BLUE") {
              img = staticAddress+'chatou_auto/static/images/maps/infowindow/downarrow_blue.png?1';
              l.css({
              ...
              img = staticAddress+'chatou_auto/static/images/maps/infowindow/downarrow_red.png?1';
              l.css({
...
function showUserPosition() {
  ...
  // infoWindow = new google.maps.InfoWindow;
        var globale_marker_image = staticAddress+'chatou_auto/static/images/maps/markers/PCT_Picto_Geoloc_51px.png';
