...
$.fn.simpleLightbox = function( options )
{
	...
	var touchDevice	= ( 'ontouchstart' in window ),
		...
		setCaption = function(captiontext, imageWidth){
			if(captiontext !== '' && typeof captiontext !== "undefined" && options.captions){
				...
				$('.sl-close, .sl-counter, .sl-navigation, .sl-spinner').fadeIn('fast');
			}
		},
						...
						if(!doubleTapped) {
							...
							setTimeout(function(){
								doubleTapped = false;
								 ...
								 elem.trigger($.Event('singletouch.simplelightbox')); 
							}, 300);
						} else {
	...
	this.hideCaption = function(){
    	...
    	//hide everything on click of slide
    	if($(".sl-caption, .sl-close, .sl-counter, .sl-navigation, .sl-spinner").is(":visible")){
	        $('.sl-caption, .sl-close, .sl-counter, .sl-navigation, .sl-spinner').hide();
	    } else {
	    	$('.sl-caption, .sl-close, .sl-counter, .sl-navigation, .sl-spinner').show();
	    }
	...
	this.showCaption = function(){
		// $('.sl-caption').fadeIn(200);
		$('.sl-caption, .sl-close, .sl-counter, .sl-navigation, .sl-spinner').fadeIn(200);
	};
	return this;
