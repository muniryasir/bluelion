...
function contextBasedMarkersOnMap(context='none',isToOpenInfoWindow) {
  ...
  function markersOnMap(step, color) {
    ...
    if (pin_color == "BLUE") {
      text_color = "#2D94D2";
      marker_image = staticAddress+'commune_de_paris/static/images/maps/markers/Pictos_Epingle_Map_blue.png';
      arrow_link = staticAddress+'commune_de_paris/static/images/maps/infowindow/arrow_link_blue.svg';
    } else if (pin_color == "RED") {
      text_color = "#E30613"
      marker_image = staticAddress+'commune_de_paris/static/images/maps/markers/Pictos_Epingle_Map_red.png';
      arrow_link = staticAddress+'commune_de_paris/static/images/maps/infowindow/arrow_link_red.svg';
    }
    ...
    <a href="/${step_link}"><div class="image" style="background:url(${image}) no-repeat;background-size:cover;background-position:center;float:left;width:35%;height:60px;"></div></a>
      ...
      for (var i=0; i<stepMarkers.length; i++) {
        ...
        if (stepMarkers[i].getPosition().equals(markerstep.getPosition())) { 
          ...
          google.maps.event.addListener(stepinfowindows[i], 'domready', function() {
            ...
            var img;
            if (pin_color == "BLUE") {
              img = staticAddress+'commune_de_paris/static/images/maps/infowindow/home_downarrow_blue.png';
              l.css({
              ...
              img = staticAddress+'commune_de_paris/static/images/maps/infowindow/home_downarrow_red_changed.png';
              l.css({
                'border': '5px solid #E30613',
                // 'background':`url(${img})  no-repeat`,
            });
              // m.css({'background':`url(${img}) no-repeat`,});
              $('head').append(`<style>.gm-style-iw.gm-style-iw-c {
...
function placePoistion(position) {
